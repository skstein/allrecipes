# Modified from http://blog.nycdatascience.com/student-works/recipes-scraping-top-20-recipes-allrecipes/
...
pages = ['https://allrecipes.com/recipes/17562/dinner/?page=' + str(p) for p in range(18,19)]
...
for j in pages:
    ...
    for i in urls: 
        ...
        try:
            ...
            print(madeitcount + ' | ' + reviewcount + ' | ' + starrating + ' | ' + readyintime + ' | ' + '; '.join(ingredients) + ' | ' + '; '.join(steps) + ' | ' + '; '.join(categories))
